...
4. Run the launcher for your platform to open your project with the latest version of Backstitch: on **macOS**, open `backstitch-launcher-macos.app` (Finder or `open backstitch-launcher-macos.app`); on **Windows** and **Linux**, run `backstitch-launcher-windows.exe` or `backstitch-launcher-linux` from a terminal in the project root.
